...
CREATE TABLE "project_doc_files" (
	"id" text PRIMARY KEY NOT NULL,
	"project_doc_id" text NOT NULL,
...
CREATE TABLE "ydoc_awareness" (
	...
	CONSTRAINT "ydoc_awareness_client_id_room_workspace_id_pk" PRIMARY KEY("client_id","room","workspace_id")
);
--> statement-breakpoint
CREATE TABLE "ydoc_resume_state" (
	...
	CONSTRAINT "ydoc_resume_state_workspace_id_room_pk" PRIMARY KEY("workspace_id","room")
);
--> statement-breakpoint
...
ALTER TABLE "project_doc_files" ADD CONSTRAINT "project_doc_files_project_doc_id_project_docs_id_fk" FOREIGN KEY ("project_doc_id") REFERENCES "public"."project_docs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "project_doc_files" ADD CONSTRAINT "project_doc_files_file_id_files_id_fk" FOREIGN KEY ("file_id") REFERENCES "public"."files"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "project_doc_files_project_doc_file_idx" ON "project_doc_files" USING btree ("project_doc_id","file_id");--> statement-breakpoint
CREATE UNIQUE INDEX "project_docs_project_id_idx" ON "project_docs" USING btree ("project_id");--> statement-breakpoint
